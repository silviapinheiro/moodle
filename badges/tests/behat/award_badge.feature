...
Feature: Award badges
  ...
  @javascript
  Scenario: Award course badge (with groups)
    Given the following "users" exist:
      | username | firstname | lastname | email |
      | teacher1 | Teacher | 1 | teacher1@example.com |
    ...
    And I follow "Potential badge recipients"
    ...
    And I follow "Potential Members"
    And I press "teacher2"
    And I press "Add"
    And I log out
    And I log in as "teacher2"
    And I am on "Course 1" course homepage
    ...
    Then I set the field "Separate groups" to "Class A"
    And I follow "Existing badge recipients"
    Then I should see "Student 2"
    And I follow "Potential badge recipients"
    And I should see "Teacher 2"
    And I follow "Separate groups"
    Then I set the field "Separate groups" to "Class B"
    And I follow "Potential badge recipients"
    And I should see "Teacher 2"
    And I log out
    # Scenario with groups but not belonging to any
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I navigate to "Users > Groups" in current page administration
    And I follow "Groups"
